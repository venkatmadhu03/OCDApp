 ...
 */
public class CartScreenActivity extends Activity {
    ArrayList<CartListData> cartListDataList = new ArrayList<CartListData>();
    AppDataBaseHelper dbHelper = new AppDataBaseHelper(CartScreenActivity.this);
    ...
    private void loadCartList() {
        boolean isNetAvailable = Utility.isOnline(CartScreenActivity.this);
        if (isNetAvailable) {
            ...
            checkOutBtn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    MySharedPreference.setPreference(CartScreenActivity.this, "FROM_SCREEN_USER", "CART");
                    LoginDetails loginDetails = dbHelper.getLoginDetails();
                    if (loginDetails != null) {
                        startActivity(new Intent(CartScreenActivity.this, ShippingAddressScreenActivity.class));
                    } else {
                        startActivity(new Intent(CartScreenActivity.this, ActivityLoginPage.class));
                    }
                }
            });
            ...
            shopNow.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    startActivity(new Intent(CartScreenActivity.this, HomeActivity.class));
                    finish();
                }
            });

            try {
                ringProgressDialog = ProgressDialog.show(CartScreenActivity.this, "Please wait ...", "Loading cart list...", true);
            ...
            LoginDetails loginDetails = dbHelper.getLoginDetails();
            String udid = Settings.Secure.getString(CartScreenActivity.this.getContentResolver(), Settings.Secure.ANDROID_ID);
            ...
            Utility.showCustomToast("Please connect your Internet!", CartScreenActivity.this);
            finish();
        }
    }
                ...
                if (response != null) {
                    ...
                    if (response.contains("no data found")) {
                        ...
                        try {
                            ...
                            MySharedPreference.setPreference(CartScreenActivity.this, "CART_TOTAL_AMOUNT", "" + cartTotalAmount);
                            MySharedPreference.setPreference(CartScreenActivity.this, "CART_ITEMS_COUNT", "" + cartCount);
                            totalAmountTV.setText(CartScreenActivity.this.getResources().getString(R.string.rs) + "" +cartTotalAmount);
                            ...
                            new Handler().postDelayed(new Runnable() {
                                ...
                                public void run() {
                                    if (cartListDataList.size() > 0) {
                                        mAdapter = null;
                                        mAdapter = new CartPlaceOrdersListAdapter(CartScreenActivity.this, cartListDataList);
        ...
        public View getView(final int position, View convertView, ViewGroup paramViewGroup) {
            ...
            holder.deleteCartItemBtn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(CartScreenActivity.this);
                    alertDialogBuilder.setMessage("Are you sure, You wanted to delete this item from cart?");

                    alertDialogBuilder.setPositiveButton("YES", new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface arg0, int arg1) {
                            if (Utility.isOnline(CartScreenActivity.this)) {
                                RequestParams params = new RequestParams();
                                LoginDetails loginDetails = dbHelper.getLoginDetails();
                                String udid = Settings.Secure.getString(CartScreenActivity.this.getContentResolver(), Settings.Secure.ANDROID_ID);
