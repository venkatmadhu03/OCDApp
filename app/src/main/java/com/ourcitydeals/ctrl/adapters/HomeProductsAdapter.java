...
public class HomeProductsAdapter extends RecyclerView.Adapter<HomeProductsAdapter.ViewHolder> {
    ...
    public HomeProductsAdapter(Context context, ArrayList<HomeProductsData> listData) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        protected RelativeLayout listItemClickRL;
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = null;
        try {
            view= LayoutInflater.from(parent.getContext()).inflate(R.layout.list_item_row_home_items, parent, false);
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        if (ci.getprice()!= null && !ci.getprice().isEmpty() && ci.getprice().equalsIgnoreCase("null") && ci.getprice().equalsIgnoreCase("0")) {
